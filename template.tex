...
\begin{document}
\name{Junsong Yang}
  \tagline{Computer Scientist \& Philosopher}
...
\personalinfo{%
  ...
  \phone{07925184216}
  \mailaddress{58 Wollaton Road, Nottingham, UK, NG81FE}
  \location{Notitngham, UK}
  \homepage{github.com/csnand}
  %\twitter{Grant Morgan}
  \linkedin{linkedin.com/in/junsong-yang/}
