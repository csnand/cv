...
\begin{document}
\makecvtitle
\makebox[0.4in][l]{性别:}男
\makebox[0.4in][l]{} 
\makebox[0.4in][l]{年龄:}23
\makebox[0.4in][l]{}
\makebox[0.7in][l]{出生年月:}1997年9月\\

\section{个人总结}
毕业于英国诺丁汉大学，计算机科学专业本硕连读课程。
对于人工智能，云计算，网络工程和软件开发有浓厚兴趣，
并有 Go, Rust, Python, Java, C++, Ruby,
Haskell, Ocaml, F\#, Elm 开发经验。


\section{教育经历} % =====================================


\cvitem{9月 2016}{ \textbf{本硕连读, 计算机科学}, \textit{诺丁汉大学}, 诺丁汉，英国.}
\cvitem{到7月 2020}{
\begin{itemize}%
\item 有 C, Java, Python, Haskell, C++, Go, Rust, Scala 的编程经验。
\end{itemize}
}

\cvitem{8月 2015}{ \textbf{清华大学}, \textit{} 北京，中国.}
\cvitem{到6月 2016}{
\begin{itemize}
\item 平均分: 92\%
\end{itemize}
...
%\cvitem{9月 2012}{ \textbf{六盘水第二实验中学}, \textit{} 贵州，中国.}
%\cvitem{到6月 2015}{}
...
\item 日常使用Linux， Nginx， PHP， Python, Go， MariaDB等工具维护和开发一个个人项目， 帮助用户优化访问境外网络
\item C, Java, Haskell, Go, Rust, Scala 实践经验
\end{itemize}
}
