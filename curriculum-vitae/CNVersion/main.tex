...
\firstname{杨竣淞}
\familyname{}
\address{上海市浦东新区德平路}{1065弄45号}
\mobile{+44 7925\ 184\ 216}
\email{askmryang@outlook.com}
...
\section{个人总结}
目前是计算机科学大二的学生，就读于英国诺丁汉大学。
对于人工智能，图像处理，云计算，网络工程和软件开发有浓厚兴趣，并有 Go, Python, Java, C++, Kotlin, PHP, Haskell, Javascript, Ruby 开发的实战经验。 目前有两个正处于开发的项目。


\section{教育经历} % =====================================


\cvitem{Sept 2016}{ \textbf{本硕连读, 计算机科学 }, \textit{诺丁汉大学 }, 英国.}
\cvitem{to June 2020}{
\begin{itemize}%
\item 大一的课程平均分达到 1st Class。
\item 有 C, Java, Python, Haskell, C++, Go, Kotlin 的编程经验。
\item \textbf{课程包括} \newline
...
\cvitem{August 2015}{ \textbf{清华-诺丁汉预科}, \textit{清华大学}, 北京, 中国.}
\cvitem{to June 2016}{
\begin{itemize}
\item 清华大学与诺丁汉大学合作办学的预科课程。
\item 平均分: 92\%
\end{itemize}
}
...
\cvitem{July 2015}{ \textbf{Linux 系统管理员}, \textit{Freelancer}}
\cvitem{to Sept 2016}{
\begin{itemize}
...
\cvitem{}{
\begin{itemize}
\item 熟练使用Linux，并获得LFCS(Linux Foundation 认证系统管理员)
