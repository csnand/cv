...
\cvitem{to present}{
\begin{itemize}
\item 成功维护若干服务器，保持其可用状态.
\item 成功开发基础和虚拟基础设施服务.
\item 负责监控服务器性能和容量管理.
\item 负责使用配置工具维护和配置若干软件.
\end{itemize}
}
...
\item 日常使用Linux， Nginx， Apache， PHP， Python, Go， MariaDB等工具维护和开发一个个人项目， 帮助用户优化访问境外网络
\item 熟练使用Go和Python
\item 在第一年的课程中学习到了团队工作的技巧和收获了软件工程等相关经验
\item 在第一年的课程中得到了C， Java， Haskell， PHP， JavaScript的实践经验
\end{itemize}
}


\section{课外活动}
\cvitem{April 2017}{技术支持(Infrastructure Secretary) - HackSoc社团}
\cvitem{to present}{
\begin{itemize}
\item 成功保证了社团基础设施的正常运转并且可以适应各种由社团活动产生的新需求
\item 成功维护了社团网站， 社交网络， 和邮件服务
\item 成功保证了社团的各种信息可以通过在线媒体发送给社团成员
\end{itemize}
}

\cvitem{May 2017}{计算机科学指导 (Computer Science Guru)}
\cvitem{to present}{
\begin{itemize}
\item 作为guru(mentor)负责为计算机科学学生提供生活上的指导，帮助他们适应大学生活
\item 负责为学生提高学习技能提供支持，尤其是独立能力
\item 帮助学生适应大学生活， 熟悉大学提供的资源和课程框架
\item 为学生在考试复习和课程选择等方面提供建议
\end{itemize}
}
