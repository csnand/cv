...
\firstname{Junsong}
\familyname{Yang}
\address{58 Wollaton Road}{Nottingham NG81FE}
\mobile{07925\ 184\ 216}
\email{askmryang@outlook.com | psyjy3@nottingham.ac.uk}
%\email{psyjy3@nottingham.ac.uk}
\homepage{linkedin.com/in/junsong-yang/}
\extrainfo{\github{
\href{https://github.com/csnand}{github.com/csnand}
}}
%\extrainfo{Chinese}
...
\section{Summary}
Currently in my second year studying Computer Science at The University of Nottingham.
Interested in all aspects of AI, Image Processing, Cloud Computing, Networking and
Software Development with experience of using Go, Python, Java, C++, Kotlin, PHP, Haskell, Javascript, Ruby


\section{Education} % =====================================


\cvitem{Sept 2016}{ \textbf{Msci (Hons) Computer Science }, \textit{The University of Nottingham }, UK.}
\cvitem{to June 2020}{
\begin{itemize}%
\item Averaged 1st class in first year module. 
\item Experience of programming in C, Java, Python, Haskell, C++, Go, Kotlin.
\item \textbf{Modules include:} \newline
Programming Paradigms (81\%) Software Engineering (66\%) \newline
Computer Fundamentals (73\%)
Programming and Algorithms (86\%)\newline
System and Architecture (65\%)
Mathematics for Computer Scientists (82\%)
\end{itemize}
}

\cvitem{August 2015}{ \textbf{Tsinghua-Nottingham Foundation}, \textit{Tsinghua University}, Beijing, China.}
\cvitem{to June 2016}{
\begin{itemize}
\item Foundation Course for computer science of The University of Nottingham.
\item Marked Obtained: 92\%
\end{itemize}
}

\cvitem{Sept 2012}{ \textbf{High School Diploma}, \textit{No.2 Experimental High School of Liupanshui City
}, China.}
\cvitem{to June 2015}{
\begin{itemize}
\item 19 subjects contribute to High School Diploma: 12 A, 4 B, 3 C.
\end{itemize}
}

\cvitem{August 2017}{ \textbf{Massive Open Online Courses}}
\cvitem{}{
\begin{itemize}%
\item Preparation of Linux Foundation Certified Sysadmin Exam, LinuxAcademy.
\end{itemize}
}

\section{Work Experience} % =====================================

\cvitem{July 2015}{ \textbf{Linux System Administrator}, \textit{Freelancer}}
\cvitem{to Sept 2016}{
\begin{itemize}
\item Successfully maintained server estates.
\item Managed to develop physical and virtual infrastructure services.
\item Responsible for monitoring performance tuning and capacity management purposes.
\item Responsible for maintaining and configuring various packages and working with config management tools.
\end{itemize}
}
...
\cvitem{}{
\begin{itemize}
\item Proficient in Linux and earned LFCS(Linux Foundation Certified Sysadmin) in my own time.
\item Using Linux, Nginx, PHP, Python, Go, MariaDB(MySQL) on a daily basis in a personal project which is to help people escape Internet censorship and anonymous while they surf the Internet.
\item Proficient in Go and Python which I learned in my own time.
\item Developed team work skills and gained software engineering experience from the first year module software engineering.
\item Learned C, Java, Haskell, PHP, JavaScript as part of first programming modules.
\end{itemize}
}


\section{Extra-curricular Activities}
\cvitem{April 2017}{Infrastructure Secretary of HackSoc Society}
\cvitem{to present}{
\begin{itemize}
\item Successfully ensuring that the technical infrastructure is in fully functioning order and able to cope with new requirements of the society throughout the year.
\item Successfully maintaining website, social networks and mailing lists.
\item Successfully ensuring announcements reach members through online media.
\end{itemize}
}

\cvitem{May 2017}{Computer Science Guru}
\cvitem{to present}{
\begin{itemize}
\item Responsible for providing pastoral support to help mentees to settle in at university as a guru(mentor).
\item Obliged to provide support to improve students’ study skills, specifically in terms of independence.
\item And to help students settle in at university and to
familiarise them with resources, people, the programme structure, etc.
\item And advising students on topics such as exam preparation and module choices.
\end{itemize}
}
