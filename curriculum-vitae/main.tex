...
\documentclass[10pt,a4paper, notos]{moderncv}
...
\firstname{Junsong}
\familyname{Yang}
\address{E34A, Nottingham Two}{Nottingham NG7 3LD}
...
\section{Summary}
Just graduated from the University of Nottingham.
Interested in all aspects of AI, Cloud Computing, Networking and
Software Development with experience of using Go, Rust, Python, Java, C++, Haskell, Ruby
...
\cvitem{to June 2020}{
\begin{itemize}%
\item Experience of programming in C, Java, Python, Haskell, C++, Go, Rust, Scala.
\end{itemize}
}
...
\cvitem{}{
\begin{itemize}
\item Proficient in Linux and earned LFCS(Linux Foundation Certified Sysadmin)
\item Experience in Nginx, PHP, Python, Go, MariaDB, Go, Python, C, Java, Haskell, PHP, JavaScript
\end{itemize}
}
