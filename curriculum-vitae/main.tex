...
\item Experience of using programming tools such as C, Java, Python, Haskell, C++, Go, Kotlin.
\item Modules have included software engineering and data analytics.
\end{itemize}
}
