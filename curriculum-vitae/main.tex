...
\firstname{Junsong}
\familyname{Yang}
\address{45, 1065 Nong Deping Road}{Pudong, Shanghai}
\mobile{13262262049}
...
Software Development with experience of using Go, Rust, Python, Java, C, Haskell
...
\cvitem{to June 2020}{
\begin{itemize}%
\item Experience of programming in Go, C, Java, Python, Haskell, C++, Rust.
\end{itemize}
}
...
\item Experience in Nginx, PHP, MariaDB, Go, Python, C, Java, Haskell, JavaScript
\end{itemize}
}
